      ...
      <CardContent className="p-4 sm:p-6 md:p-8">
        ...
        >
          ...
          >
            ...
            >
              Contribute to Okoa Sem
            </motion.h2>
            <motion.p
              variants={itemVariants}
              className="text-sm sm:text-base text-muted-foreground max-w-prose"
            >
              Do you have an idea on how to improve the platform? Share it with
              the community! Open a PR and help grow this curated list.
            </motion.p>
          </motion.div>
          <motion.div variants={itemVariants} className="w-full lg:w-auto">
            <Button asChild size="lg" className="w-full lg:w-auto text-base">
              <a
                href="https://github.com/devalentineomonya/Okoa-Sem-NextJs-Ts-Prisma-Supabase"
                target="_blank"
